...
define({
  ...
  "searchSourceSetting": {
    ...
    "errorMessageLabel": "Μήνυμα σφάλματος",
    "errorMessageHint": "Υπόδειξη: Καθορίστε ένα μήνυμα που θα εμφανίζεται όποτε δεν εντοπίζονται αποτελέσματα",
  ...
  "routeSetting": {
    ...
    "enableDirectionLabel": "Ενεργοποίηση οδηγιών",
    "enableDirectionText": "Υπόδειξη: Έλεγχος για ενεργοποίηση των οδηγιών στο widget"
  },
