...
define({
  root: ({
    ...
    routeSetting: {
      ...
      enableDirectionLabel: "Enable Directions", // shown as a label in config UI to enable directions
      enableDirectionText: "Hint: Check to enable directions in the widget" // shown as hint label in config UI for enable direction
    },
